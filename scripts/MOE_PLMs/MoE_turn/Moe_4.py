...
def run_regression(train_x1, train_x2, train_x3, train_x4, train_target, test_x1, test_x2, test_x3, test_x4, test_target):
...
def run_regression_on_files(train_feat_paths, train_meta_path, test_feat_paths, test_meta_path):
    ...
    metrics = run_regression(
        ...
        test_x1_scaled, test_x2_scaled, test_x3_scaled, test_x4_scaled, test_target  # test_target来自test_meta
    )
