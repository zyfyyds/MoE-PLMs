...
python MoE-PLMs/MoE_pred/Transfer/MOE_transfer.py  file_path  output_path ...
...
python MoE-PLMs/MoE_pred/Transfer/DTm-transfer.py train_file_path test_file_path pretrained final_best_model.pth  output_path ....
```
